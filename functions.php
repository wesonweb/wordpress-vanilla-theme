...
function vanilla_register_styles(){
	...
	wp_enqueue_style('google-font', "https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,400;0,700;1,400&display=swap");
}
add_action( 'wp_enqueue_scripts', 'vanilla_register_styles' );
...
require(get_template_directory().'/custom-code/dynamic-sidebars.php');
